...
#### Properties of rpm package release
...
#### Casts of rpm package release

{% cast <rpm package release> as rpm package release %}

No documentation exists for this cast.

{% cast <rpm package release> as string %}
...
#### Properties of rpm package release with multiplicity
...
#### Properties of rpm package version
...
#### Casts of rpm package version

{% cast <rpm package version> as rpm package version %}

No documentation exists for this cast.

{% cast <rpm package version> as string %}
...
#### Properties of rpm package version record
...
#### Casts of rpm package version record

{% cast <rpm package version record> as rpm package version record %}

No documentation exists for this cast.

{% cast <rpm package version record> as short rpm package version record %}

Casts an RPM package version record as a short version by stripping the epoch off.

{% cast <rpm package version record> as string %}
...
#### Properties of rpm package version record with multiplicity
...
#### Properties of rpm package version with multiplicity
...
#### Properties of short rpm package version record
...
#### Casts of short rpm package version record

{% cast <short rpm package version record> as rpm package version record %}

Casts a short RPM Package version record as a long version.

{% cast <short rpm package version record> as short rpm package version record %}

No documentation exists for this cast.

{% cast <short rpm package version record> as string %}
...
#### Properties of short rpm package version record with multiplicity
