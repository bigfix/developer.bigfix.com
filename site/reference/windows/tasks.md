...
#### Properties of boot task trigger
...
#### Properties of com handler task action
...
#### Properties of daily task trigger
...
#### Properties of email task action
...
#### Properties of event task trigger
...
#### Properties of exec task action
...
#### Properties of logon task trigger
...
#### Properties of monthly task trigger
...
#### Properties of monthlydow task trigger
...
#### Properties of registration task trigger
...
#### Properties of session state change task trigger
...
#### Properties of show message task action
...
#### Casts of task action

{% cast <task action> as com handler task action %}

Casts the specified task action as a com handler task action.

{% cast <task action> as email task action %}

Casts the specified task action as an email action.

{% cast <task action> as exec task action %}

Casts the specified task action as an executable action.

{% cast <task action> as show message task action %}
...
#### Properties of task idle settings
...
#### Properties of task named value pair
...
#### Properties of task network settings
...
#### Properties of task registration info
...
#### Properties of task repetition pattern
...
#### Properties of time task trigger
...
#### Properties of weekly task trigger
