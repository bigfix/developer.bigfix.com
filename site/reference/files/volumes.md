...
#### Casts of logical volume

{% cast <logical volume> as string %}
...
#### Properties of logical volume manager
...
#### Casts of volume group

{% cast <volume group> as string %}
