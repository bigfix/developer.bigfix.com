...
#### Properties of date with multiplicity
...
#### Casts of day of month

{% cast <day of month> as integer %}
...
{% cast <day of month> as string %}

Cast a day of month type as a string.

{% cast <day of month> as two digits %}
...
#### Properties of day of month with multiplicity
...
#### Casts of day of week

{% cast <day of week> as string %}

Casts the day of week as a string.

{% cast <day of week> as three letters %}
...
#### Properties of day of week with multiplicity
...
#### Casts of day of year

{% cast <day of year> as string %}
...
#### Properties of day of year with multiplicity
...
#### Casts of month and year

{% cast <month and year> as string %}
...
#### Properties of month and year with multiplicity
...
#### Properties of month with multiplicity
...
#### Properties of number of months
...
#### Casts of number of months

{% cast <number of months> as string %}
...
#### Properties of number of months with multiplicity
...
#### Casts of time interval

{% cast <time interval> as string %}
...
#### Properties of time interval with multiplicity
...
#### Casts of time of day

{% cast <time of day> as string %}
...
#### Properties of time of day with multiplicity
...
#### Properties of time of day with time zone
...
#### Casts of time of day with time zone

{% cast <time of day with time zone> as string %}
...
#### Properties of time of day with time zone with multiplicity
...
#### Properties of time range with multiplicity
...
#### Properties of time with multiplicity
...
#### Properties of time zone with multiplicity
...
#### Properties of year with multiplicity
