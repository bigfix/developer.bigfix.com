...
#### Properties of action lock state
...
#### Casts of action lock state

{% cast <action lock state> as string %}
...
#### Casts of manual group

{% cast <manual group> as string %}
...
#### Properties of site profile variable
...
#### Casts of site profile variable

{% cast <site profile variable> as string %}
...
#### Properties of site version list
...
#### Casts of site version list

{% cast <site version list> as string %}
...
#### Properties of site version list with multiplicity
